class Response:
    ...
    partialToolUse = "[Error] The tool use is not complete! Please retry with a complete tool use. Note: Maybe the output content too long, causing the output to be truncated."
